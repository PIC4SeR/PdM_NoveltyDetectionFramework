        ...
        public:
            ...
            class TcMathDeviationInterval{
                ...
                private:
                    ...
                    double rmMLinear;
                    chrono::system_clock::time_point cmStartTime;
                    chrono::system_clock::time_point cmEndTime;
                    int rmStartIndex;
                    int rmEndIndex;
                ...
                public:
                    ...
                    TcMathDeviationInterval(Deviation pDeviation, double pMLinear, int pStartIndex, int pEndIndex, chrono::system_clock::time_point pStartTime, chrono::system_clock::time_point pEndTime);
                    ~TcMathDeviationInterval();
                    double fGetMLinear();
                    Deviation fGetDeviation();
                    chrono::system_clock::time_point fGetEndTime();
                    chrono::system_clock::time_point fGetStartTime();
                    int fGetStartIndex();
                    int fGetEndIndex();
                    ...
                    void fSetStartTime(chrono::system_clock::time_point pStartTime);
                    void fSetEndTime(chrono::system_clock::time_point pEndTIme);
                    bool fIsConstant();
                    bool fIsLinear(double *pMLinear);
                    bool fIsImpulsive(double *pMLinear);
                    void fSetObject(TcMathSupporter::TcMathDeviationDetector::Deviation pDeviation, double pMLinear, int pStartIndex, int pEndIndex, chrono::system_clock::time_point cmStartTime, chrono::system_clock::time_point cmEndTime);
            };
            ...
            public:
                ...
                TcMathDeviation();
                TcMathDeviation(DeviationDistribution pDeviation, double pDevVal, double pNormVal, double pMLinear, int pStartIndex, int pEndIndex, chrono::system_clock::time_point pStartTime, chrono::system_clock::time_point pEndTime);
                ~TcMathDeviation();
                double fGetMLinear();
                double fGetDev();
                ...
                void fSetMLinear(double pMLinear);
                void fSetObject(DeviationDistribution pDeviation, double pDevVal, double pNormVal, double pMLinear, int pStartIndex, int pEndIndex, chrono::system_clock::time_point pStartTime, chrono::system_clock::time_point pEndTime);
            ...
            class TcConst{
            public:
                static const int kErrorTolleranceMultiplier = 3;
            ...
            typedef void (*fNotifyDeviation)(TcMathSupporter::TcMathDeviationDetector::TcMathDeviation pDeviation);
            
            vector<TcMathDeviationInterval> *cmMathDeviationIntervals;
            vector<TcMathDeviation> *cmDeviations;
            fNotifyDeviation fmNotify = nullptr;

            TcMathDeviationDetector(fNotifyDeviation pNotify);
            TcMathDeviationDetector();
            ~TcMathDeviationDetector();

            fNotifyDeviation fGetNotifyFunction();
            ...
            void fSetNotifyFunction(fNotifyDeviation pNotify);


            void fAddDeviationInterval(Deviation pDeviation, double pMLinear, int pStartIndex, int pEndIndex, chrono::system_clock::time_point pStartTime, chrono::system_clock::time_point pEndTime);
            void fAddDeviation(DeviationDistribution pDeviation, double pMLinear, double pDevVal, double pNormVal, int pStartLinearIndex, int pEndLinearIndex, chrono::system_clock::time_point pStartTime, chrono::system_clock::time_point pEndTime);
            
            int fDetect(double pUnitScaleFactor, vector<double> pMvals, vector<double> pVals, vector<long long> pTimes, vector<TcMathSupporter::TcMathDeviationDetector::TcMathDeviation>* pDeviations);
            bool fDetectDeviation(vector<double> pVals, vector<long long> pTimes, TcMathDeviation* pDeviation);

            static bool fShift(vector<TcMathDeviationInterval> pDetectedIntervals, TcMathDeviation* pDeviation);
            static bool fDrop(vector<TcMathDeviationInterval> pDetectedIntervals, TcMathDeviation* pDeviation);
            static bool fGlitch(vector<TcMathDeviationInterval> pDetectedIntervals, TcMathDeviation* pDeviation);
            static bool fDrift(vector<TcMathDeviationInterval> pDetectedIntervals, TcMathDeviation* pDeviation);
