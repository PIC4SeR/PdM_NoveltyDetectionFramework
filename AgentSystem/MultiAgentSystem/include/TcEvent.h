...
public:
    ...
    public:
        ...
        static const string rpTimestampMicroEpoch;
        static const string rpRemark;
    };

    TcEvent();
    TcEvent(string pId, uint64_t pEventID, string pEventData, chrono::system_clock::time_point pTimestamp, uint64_t pTimestampEpoch, string pRemark);
