...
TcEvent::TcEvent(string pId, uint64_t pEventID, string pEventData, chrono::system_clock::time_point pTimestamp, uint64_t pTimestampEpoch, string pRemark){
    this->_id = pId;
...
const string TcEvent::TcEventAttributes::rpEventID = "EventID";
const string TcEvent::TcEventAttributes::rpEventData = "EventData";
const string TcEvent::TcEventAttributes::rpTimestamp = "Timestamp";
const string TcEvent::TcEventAttributes::rpTimestampEpoch = "TimestampEpoch";
const string TcEvent::TcEventAttributes::rpRemark = "Remark";
